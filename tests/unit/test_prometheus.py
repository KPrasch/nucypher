...
def test_prometheus_metrics_config():
    ...
    prometheus_config = PrometheusMetricsConfig(port=port, metrics_prefix=TEST_PREFIX)
...
class TestGenerateJSON(unittest.TestCase):
    ...
    def test_counter(self):
        ...
        self.assertEqual(
            json.loads(
                """{"cc": {"samples": [{"sample_name": "cc_total", "labels": {}, "value": "1.0", 
    ...
    def test_counter_name_unit_append(self):
        ...
        self.assertEqual(
            json.loads(
                """{"requests_value": {"samples": [{"sample_name": "requests_value_total", 
    ...
    def test_gauge(self):
        ...
        self.assertEqual(
            json.loads(
                """{"gg": {"samples": [{"sample_name": "gg", "labels": {}, "value": "17.0",
    ...
    def test_summary(self):
        ...
        self.assertEqual(
            json.loads(
                """{"ss": {"samples": [{"sample_name": "ss_count", "labels": {"a": "c", 
    ...
    def test_gaugehistogram(self):
        self.custom_collector(
            GaugeHistogramMetricFamily(
                "gh", "help", buckets=[("1.0", 4), ("+Inf", 5)], gsum_value=7
            )
        )
        self.assertEqual(
            json.loads(
                """{"gh": {"samples": [{"sample_name": "gh_bucket", "labels": {"le": "1.0"}, 
        ...
        "timestamp": null, "exemplar": {}}], "help": "help", "type": "gaugehistogram"}}"""
            ),
            json.loads(self.json_exporter.generate_latest_json()),
        )
    ...
    def test_enum(self):
        i = Enum(
            "ee", "An enum", ["a", "b"], registry=self.registry, states=["foo", "bar"]
        )
    ...
    def test_unicode(self):
        ...
        self.assertEqual(
            json.loads(
                """{"cc": {"samples": [{"sample_name": "cc", "labels": {"l": "\\u4500"}, "value":
    ...
    def test_escaping(self):
        ...
        self.assertEqual(
            json.loads(
                """{"cc": {"samples": [{"sample_name": "cc", "labels": {"a": "\\\\x\\n\\""},
    ...
    def test_nonnumber(self):
        ...
        self.assertEqual(
            json.loads(
                """{"nonnumber": {"samples": [{"sample_name": "nonnumber", "labels": {}, "value": 
    ...
    def test_timestamp(self):
        ...
        self.assertEqual(
            json.loads(
                """{"ts": {"samples": [{"sample_name": "ts", "labels": {"foo": "a"}, "value": 
        ...
        123.000000456, "exemplar": {}}], "help": "help", "type": "unknown"}}"""
            ),
            json.loads(self.json_exporter.generate_latest_json()),
        )
