...
def test_bridge(get_random_checksum_address):
    destination_contract_address = get_random_checksum_address()
    destination_chain = 1

    origin_contract_address = get_random_checksum_address()
    origin_chain = 85432
        ...
        [
            ...
            ConditionVariable(
                ...
                condition=ContractCondition(
                    contract_address=destination_contract_address,
            ...
            ConditionVariable(
                ...
                condition=ContractCondition(
                    ...
                    parameters=":orderID",
                    return_value_test=ReturnValueTest(comparator="!=", value="0x"),
                ),
            ),
            ConditionVariable(
                var_name="intentID",
            ...
            ConditionVariable(
                ...
                condition=ContractCondition(
                    ...
                    return_value_test=ReturnValueTest(
                        comparator="==",
                        value=IntentStatus.AWAITING_EXECUTION,
                    ),
                ),
            ),
            ConditionVariable(
                ...
                condition=ContractCondition(
                    ...
                    method="getIntent",
                    parameters=":intentID",
                    return_value_test=ReturnValueTest(comparator="!=", value=[0, 0, 0]),
                ),
            ),
            ConditionVariable(
                # origin contract
                ...
                condition=ContractCondition(
                    ...
                    parameters=[":orderID"],
                    return_value_test=ReturnValueTest(
                        comparator="==", value=":destinationIntent"
                    ),
                ),
            ),
        ]
        ...
        [
            ...
            ConditionVariable(
                ...
                condition=ContractCondition(
                    ...
                    return_value_test=ReturnValueTest(
                        comparator="==",
                        value=OrderStatus.AWAITING_FULFILLMENT,
                    ),
                ),
            ),
        ]
